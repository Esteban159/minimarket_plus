...
<head>
  ...
  <spring:url value="/resources/img/portada.jpg" var="imagen" />
  ...
  <div class="container-fluid" id="header2">
    <div class="row" id="header5">
      ...
      <div class="col-md-4 header6">
        <form class="form-horizontal" method="get" action="/validando">
          <div class="form-group">
            <label for="inputEmail3" class="col-md-2 control-label">USUARIO</label>
            <div class="col-md-7 col-md-push-1">
              <input type="email" name="usuario" class="form-control header3" id="inputEmail3" placeholder="USUARIO" required autofocus/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputPassword3" class="col-md-2 control-label">CONTRASEÑA</label>
            <div class="col-md-7 col-md-push-1">
              <input type="password" name="contrasenha" class="form-control header3" id="inputPassword3" placeholder="........" required />
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
              ...
              <button type="button"  action="registro" class="btn btn-success" >
...
<section class="col-md-12">
  <div class="container col-md-12">
    <div class="row">
      <div class="col-md-12">
        <img  src="${imagen}" class="col-md-10 col-md-push-1" id="imagen"/>
      </div>
    </div>
  </div>
</section>
