  ...
  <div class="container-fluid" id="header2">
    <div class="row" id="header5">
      ...
      <div class="col-md-4 header6">
        <form class="form-horizontal" method="get" action="/agregar-usuario">
          <div class="form-group">
            <label for="inputEmail3" class="col-md-2 control-label">USUARIO</label>
            <div class="col-md-7 col-md-push-1">
              <input type="email" class="form-control header3" name="miatributo" id="inputEmail3" placeholder="USUARIO" required autofocus/>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
              ...
              <button type="button"  class="btn btn-success" >
                <a href="vistas/registro.html" id="header8">REGISTRARSE</a>
              </button>
              Mi usuario es ${jusuario.email}
            </div>
          </div>
        </form>
      </div>
